...
class Book extends Model  
{
     ...
     * @var array
     */
    protected $fillable = ['title', 'author', 'description', 'total_rating', 'price', 'profit_precentage', 'num_of_copies', 'publish_date', 'category_id', 'created_at', 'updated_at', 'deleted_at'];
